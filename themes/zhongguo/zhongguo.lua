...
-- {{{ Main
theme = {}
--theme.themedir       = "/usr/share/awesome/"
theme.themedir       = "~/.config/awesome/themes/zhongguo"
...
--
-- {{{ Taglist icons
theme.taglist_squares_sel   = theme.themedir .. "/icons/taglist/squarefza.png"
theme.taglist_squares_unsel = theme.themedir .. "/icons/taglist/squarez.png"
